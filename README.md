...
> **Note:** For complete third-party license details, see [THIRD_PARTY_LICENSES.md](THIRD_PARTY_LICENSES.md).
...
For complete third-party license details, see [THIRD_PARTY_LICENSES.md](THIRD_PARTY_LICENSES.md).
